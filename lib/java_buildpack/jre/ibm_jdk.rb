...
require 'java_buildpack/container/common_paths'
require 'java_buildpack/repository/configured_item'
require 'java_buildpack/util/cache/application_cache'
require 'java_buildpack/util/format_duration'
require 'java_buildpack/util/tokenized_version'
require 'java_buildpack/util/license_management'
...
module JavaBuildpack::Jre
  ...
  class IBMJdk
    ...
    def initialize(context)
      ...
      @common_paths = context[:common_paths] || JavaBuildpack::Container::CommonPaths.new
    ...
    def compile
      ...
      unless JavaBuildpack::Util.check_license(@license, @license_id)
      ...
      JavaBuildpack::Util::Cache::ApplicationCache.new.get(@uri) do |file| # TODO: Use global cache
    ...
    def self.find_ibmjdk(configuration)
      version, entry = JavaBuildpack::Repository::ConfiguredItem.find_item(configuration)
      if entry.is_a?(Hash)
